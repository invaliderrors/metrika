...
**Definition of done.** `pnpm verify` passes on a clean clone. CI green. A trace spanning all three runtimes is visible in Grafana with a single request ID. ADR-0009 records the ts-rest decision with evidence.
